...
* [Linux - Privilege Escalation](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Linux%20-%20Privilege%20Escalation.md) ⭐ 80,646 | 🐛 35 | 🌐 Python | 📅 2026-08-27: Methodology from PayloadsAllTheThings
...
* [Privilege Escalation Cheatsheet (Vulnhub)](https://github.com/Ignitetechnologies/Privilege-Escalation) ⭐ 3,634 | 🐛 2 | 📅 2026-03-14: This cheasheet is aimed at the CTF Players and Beginners to help them understand the fundamentals of Privilege Escalation with examples.
...
* [LinPEAS](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/linPEAS) ⭐ 20,441 | 🐛 0 | 🌐 C# | 📅 2026-09-05: Linux Privilege Escalation Awesome Script
* [LinEnum](https://github.com/rebootuser/LinEnum) ⭐ 8,027 | 🐛 25 | 🌐 Shell | 📅 2023-09-06: Scripted local Linux enumeration & privilege escalation checks
...
* [LES](https://github.com/mzet-/linux-exploit-suggester) ⭐ 6,605 | 🐛 24 | 🌐 Shell | 📅 2026-03-20: LES: Linux privilege escalation auditing tool
* [pspy](https://github.com/DominicBreuker/pspy) ⭐ 6,176 | 🐛 3 | 🌐 Go | 📅 2026-03-01: unprivileged Linux process snooping
...
* [Windows - Privilege Escalation](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Windows%20-%20Privilege%20Escalation.md) ⭐ 80,646 | 🐛 35 | 🌐 Python | 📅 2026-08-27
* [Windows Local Privilege Escalation Cookbook](https://github.com/nickvourd/Windows-Local-Privilege-Escalation-Cookbook) ⭐ 1,373 | 🐛 3 | 🌐 PowerShell | 📅 2026-02-05: Windows Local Privilege Escalation Cookbook by nickvourd.
...
* [winPEAS](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/winPEAS) ⭐ 20,441 | 🐛 0 | 🌐 C# | 📅 2026-09-05: Windows Privilege Escalation Awesome Scripts
...
* [Windows Exploit Suggester - Next Generation (WES-NG)](https://github.com/bitsadmin/wesng) ⭐ 4,926 | 🐛 9 | 🌐 Python | 📅 2026-09-04: WES-NG is a tool based on the output of Windows' systeminfo utility which provides the list of vulnerabilities the OS is vulnerable to, including any exploits for these vulnerabilities. Every Windows OS between Windows XP and Windows 10, including their Windows Server counterparts, is supported. By bitsadmin
...
* [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,318 | 🐛 37 | 🌐 Python | 📅 2026-05-19: The AWS exploitation framework, designed for testing the security of Amazon Web Services environments. By RhinoSecurityLabs.
