...
* [Linux - Privilege Escalation](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Linux%20-%20Privilege%20Escalation.md) ⭐ 81,158 | 🐛 36 | 🌐 Python | 📅 2026-08-27: Methodology from PayloadsAllTheThings
...
* [LinPEAS](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/linPEAS) ⭐ 20,568 | 🐛 2 | 🌐 C# | 📅 2026-09-24: Linux Privilege Escalation Awesome Script
* [LinEnum](https://github.com/rebootuser/LinEnum) ⭐ 8,037 | 🐛 25 | 🌐 Shell | 📅 2023-09-06: Scripted local Linux enumeration & privilege escalation checks
...
* [pspy](https://github.com/DominicBreuker/pspy) ⭐ 6,195 | 🐛 3 | 🌐 Go | 📅 2026-03-01: unprivileged Linux process snooping
...
* [GTFONow](https://github.com/Frissi0n/GTFONow) ⭐ 638 | 🐛 56 | 🌐 Python | 📅 2026-09-18: Automatic privilege escalation for misconfigured capabilities, sudo and suid binaries using GTFOBins.
...
* [Windows - Privilege Escalation](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Windows%20-%20Privilege%20Escalation.md) ⭐ 81,158 | 🐛 36 | 🌐 Python | 📅 2026-08-27
...
* [winPEAS](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/winPEAS) ⭐ 20,568 | 🐛 2 | 🌐 C# | 📅 2026-09-24: Windows Privilege Escalation Awesome Scripts
...
* [PrivescCheck](https://github.com/itm4n/PrivescCheck) ⭐ 3,964 | 🐛 1 | 🌐 PowerShell | 📅 2026-09-21: Enumerate common Windows security misconfigurations which can be leveraged for privilege escalation and gather various information which might be useful for exploitation and/or post-exploitation, by itm4n.
...
* [JAWS - Just Another Windows (Enum) Script](https://github.com/411Hall/JAWS) ⭐ 2,000 | 🐛 6 | 🌐 PowerShell | 📅 2021-04-19: JAWS is PowerShell script designed to help penetration testers (and CTFers) quickly identify potential privilege escalation vectors on Windows systems. It is written using PowerShell 2.0 so 'should' run on every Windows version since Windows 7.
* [SweetPotato](https://github.com/CCob/SweetPotato) ⭐ 1,843 | 🐛 8 | 🌐 C# | 📅 2024-09-04:  Local Service to SYSTEM privilege escalation from Windows 7 to Windows 10 / Server 2019 by CCob
...
* [ADAPE-Script](https://github.com/hausec/ADAPE-Script) ⭐ 1,124 | 🐛 2 | 🌐 PowerShell | 📅 2022-12-07: Active Directory Assessment and Privilege Escalation Script by hausec
...
* [Awesome-Hacking-Resources (Privilege escalation section)](https://github.com/vitalysim/Awesome-Hacking-Resources#privilege-escalation) ⭐ 17,441 | 🐛 30 | 📅 2026-05-21: A collection of hacking / penetration testing resources to make you better!
...
* [CDK](https://github.com/cdk-team/CDK) ⭐ 4,757 | 🐛 15 | 🌐 Go | 📅 2026-05-01: CDK is an open-sourced container penetration toolkit, offering stable exploitation in different slimmed containers without any OS dependency.
